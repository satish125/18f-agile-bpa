...
module.exports = function (grunt) {
    ...
    copy: {
      ...
      staticFiles: {
        files: [
          ...
          {cwd: 'client/', src: ['images/**'], dest: 'dist/',filter:'isFile',expand:true},
  ...
  grunt.registerTask('build',['jshint','clean:before','copy:staticFiles','less','dom_munger','ngtemplates','cssmin','concat','ngAnnotate','uglify','copy','htmlmin','clean:after']);
